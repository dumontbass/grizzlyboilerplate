Ext.define('MyApp.controller.AbstractController', {
    ...
    views: [
        ...
        'MyApp.views.compra.ComandaFormPanel.js',
        'MyApp.views.compra.ComandaGridPanel.js',
        'MyApp.views.compra.PedidoComandaGridPanel.js',

        'MyApp.views.configuracao.ConfiguracaoFormPanel.js',

        'MyApp.views.item.CardapioFormPanel.js',
        'MyApp.views.item.CardapioGridPanel.js',
